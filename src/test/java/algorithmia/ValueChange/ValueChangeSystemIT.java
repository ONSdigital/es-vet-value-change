...
public class ValueChangeSystemIT {
    ...
    @Test
    public void validationRuleIsTriggeredWhenValueDecreasesByMoreThanThreshold() throws Exception {
        String inputWithValueDecreaseInExcessOfThreshold = "{\"value1\":\"10\", \"value2\":\"5\"," +
                "\"absoluteDecreaseThreshold\":\"4\", \"percentDecreaseThreshold\":\"40\"}";

        OutputData output = client.algo(ALGORITHM_DESCRIPTOR).pipe(inputWithValueDecreaseInExcessOfThreshold).as(OUTPUT_DATA_TYPE);
